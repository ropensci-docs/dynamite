...
This outlines how to propose a change to dynamite, modified from the
[`usethis::use_tidy_contributing`](https://usethis.r-lib.org/reference/tidyverse.html).
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/dynamite", fork = TRUE)`.
